      ...
      <div>
        ...
        {isLoading ? (
          ...
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded">
            <p>{error}</p>
            <Link href="/jobs" className="mt-4 text-blue-600 hover:underline block">
            ...
            <div className="p-6 bg-gray-50 border-t border-gray-200">
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button
                  ...
                  onClick={() => window.open('mailto:apply@jobmatch.example.com?subject=Application for ' + job.title, '_blank')}
                >
                  Apply for This Job
                </button>
              </div>
